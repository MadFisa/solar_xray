...
# par_dict[1] = "7,0.1,,,, "
# par_dict[33] = "6.8,0.1,,,, "
m = xp.Model("chisoth + chisoth + chisoth", "flare", setPars=par_dict)
model_components_list = m.componentNames
FIP_par_index = []
other_par_index = []
for component_i in model_components_list[:-1]:
...
# df[df<0]= 0
# df[df>1e3] = 0
df.to_csv(f"{out_dir}/results_2.csv")
